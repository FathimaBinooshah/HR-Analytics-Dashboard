...
* Track total, current, and ex-employees
...
Common fields included in the dataset:
...
* Import Excel/CSV dataset into Microsoft Power BI
* Verify data types
* Handle missing/null values
* Format numeric and categorical columns correctly
...
Displays total active employees.

### Ex-Employees

Displays total employees who left the organization.
...
Analyzed which department experiences the highest employee turnover.
...
Studied whether employees living farther from the workplace are more likely to leave.

---

## Salary Distribution Analysis

Compared monthly income across different job roles.

---

## Employee Retention Analysis

Examined employee tenure patterns between retained and exited employees.
...
* Main causes of employee attrition
...
* Power BI dashboard development skills
...
A fully interactive HR Analytics Dashboard that enables stakeholders to:
